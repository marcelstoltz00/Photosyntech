...
SummerIterator::SummerIterator(AggSummer* aggregate) : currentPlant(nullptr)
{
...
LivingPlant* SummerIterator::findNextMatch(std::list<PlantComponent*>* plants, bool findFirst)
{
