...
PlantComponent* NurseryFacade::createPlant(const std::string& type) {
    ...
    if(type == "Sunflower") selectedBuilder = sunflowerBuilder;
    else if(type == "Rose") selectedBuilder = roseBuilder;
    else if(type == "Jade Plant") selectedBuilder = jadePlantBuilder;
    else if(type == "Maple") selectedBuilder = mapleBuilder;
    else if(type == "Cactus") selectedBuilder = cactusBuilder;
    else if(type == "Cherry Blossom") selectedBuilder = cherryBlossomBuilder;
    else if(type == "Lavender") selectedBuilder = lavenderBuilder;
    else if(type == "Pine") selectedBuilder = pineBuilder;
    else return nullptr;
